        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card-box widget-user">
                    <div>
                        <img src="/modules/admin/images/users/avatar-1.jpg" class="img-responsive img-circle" alt="user">
                ...
                <div class="card-box widget-user">
                    <div>
                        <img src="/modules/admin/images/users/avatar-2.jpg" class="img-responsive img-circle" alt="user">
                        <div class="wid-u-info">
                ...
                <div class="card-box widget-user">
                    <div>
                        <img src="/modules/admin/images/users/avatar-7.jpg" class="img-responsive img-circle" alt="user">
                        <div class="wid-u-info">
...
@section('srcScript')
     <!-- Counter Up  -->
    <script src="/modules/admin/plugins/waypoints/lib/jquery.waypoints.js"></script>
    <script src="/modules/admin/plugins/counterup/jquery.counterup.min.js"></script>

    <!-- circliful Chart -->
    <script src="/modules/admin/plugins/jquery-circliful/js/jquery.circliful.min.js"></script>
    <script src="/modules/admin/plugins/jquery-sparkline/jquery.sparkline.min.js"></script>

    <!-- skycons -->
    <script src="/modules/admin/plugins/skyicons/skycons.min.js" type="text/javascript"></script>
    
    <!-- Page js  -->
    <script src="/modules/admin/pages/jquery.dashboard.js"></script>
@endsection
