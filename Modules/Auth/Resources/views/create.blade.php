                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="displayNameForm" name="display_name" class="form-control" placeholder="...">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="descriptionForm">Description</label>
                                    <div class="col-md-6">
                                        <textarea name="description" id="descriptionForm" cols="15" rows="5" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
